...
export const NavBar = ({ showOverlay, setShowOverlay }: any) => {
  ...
  return (
    <div className={`navbar ${style.nav}  bg-mhsky font-bold text-fontDarkBlue text-3xl`}>
      <div className={`${style.logo}  ${menuOpen ? `${style.logoNone}` : ""} flex-1`}>
      ...
      <div className={`${style.containerNav} flex-none`}>
        ...
        <ul className={` ${style.menuNav} ${menuOpen ? `${style.menuNavopen} ${style.navopen} ${style.logoNone}` : ""} menu menu-horizontal px-1`}>
          <li className={` ${style.ulist} rounded hover:bg-mhpurple-200`}><Link href="/#info">about</Link></li>
          <li className={` ${style.ulist} rounded hover:bg-mhpurple-200`}><Link href="/#application">application</Link></li>
        
  
          <li className={` ${style.ulist} rounded hover:bg-mhpurple-200`}><Link href="/#team">team</Link></li>
          ...
          <li className={`${style.ulist}`}  tabIndex={0} >
            ...
            <ul className={` ${style.sublist} p-2 bg-mhsky `}>
              ...
              <li className={` ${style.ulist} hover:bg-mhpurple-200`}><Link href="/#prizes">prizes</Link></li>
